...
const Heroheader = () => (
    <section id="home" className="h-screen flex flex-col items-center justify-around">
        <div className="container mb-20 flex lg:flex-row flex-col-reverse lg:bottom-auto bottom-5 my:auto z-20">
